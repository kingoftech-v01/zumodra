    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career_site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='job_listings', to='careers.careersite')),
                ('job', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='public_listing', to='ats.jobposting')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('career_site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='custom_pages', to='careers.careersite')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career_site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_alerts', to='careers.careersite')),
            ],
            options={
                'verbose_name': 'Job Alert',
                'verbose_name_plural': 'Job Alerts',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['status', 'frequency'], name='careers_job_status_fcea36_idx'), models.Index(fields=['confirmation_token'], name='careers_job_confirm_f63f52_idx'), models.Index(fields=['unsubscribe_token'], name='careers_job_unsubsc_9c5814_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='views', to='careers.joblisting')),
            ],
            options={
                'verbose_name': 'Job View',
                'verbose_name_plural': 'Job Views',
                'ordering': ['-viewed_at'],
                'indexes': [models.Index(fields=['job_listing', 'viewed_at'], name='careers_job_job_lis_390a3a_idx'), models.Index(fields=['viewed_at'], name='careers_job_viewed__0c1ebc_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ats_application', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ats.application')),
                ('ats_candidate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ats.candidate')),
                ('career_site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='careers.careersite')),
                ('job_listing', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='public_applications', to='careers.joblisting')),
            ],
            options={
                'verbose_name': 'Public Application',
                'verbose_name_plural': 'Public Applications',
                'ordering': ['-submitted_at'],
                'indexes': [models.Index(fields=['email', 'job_listing'], name='careers_pub_email_905352_idx'), models.Index(fields=['status', 'submitted_at'], name='careers_pub_status_f03604_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='talent_pools', to='ats.candidate')),
                ('pool', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='members', to='careers.talentpool')),
            ],
            options={
