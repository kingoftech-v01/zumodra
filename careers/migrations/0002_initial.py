...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='joblisting',
            name='job',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='public_listing', to='ats.jobposting'),
        ),
        migrations.AddField(
            model_name='jobview',
            name='job_listing',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ats.application'),
        ),
        migrations.AddField(
            model_name='publicapplication',
            name='ats_candidate',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ats.candidate'),
        ),
        migrations.AddField(
            model_name='publicapplication',
            name='career_site',
        ...
        migrations.AddField(
            model_name='talentpoolmember',
            name='candidate',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='talent_pools', to='ats.candidate'),
        ),
        migrations.AddField(
            model_name='talentpoolmember',
            name='pool',
