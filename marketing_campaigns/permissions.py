"""
marketing_campaigns Permissions

Role-based access control for marketing_campaigns functionality.
"""

from rest_framework import permissions


class IsMarketingCampaignsAdmin(permissions.BasePermission):
    """
