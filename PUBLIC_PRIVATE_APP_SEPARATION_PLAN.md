...
urlpatterns = [
    ...
    path('app/ats/', include('ats.urls_frontend', namespace='ats')),
    path('app/services/', include('services.urls_frontend', namespace='services')),
    path('api/v1/ats/', include('ats.api.urls')),
...
4. Create templates in `templates/ats_public/` and `templates/services_public/`
...
│
├── ats/                     # EXISTING: Private ATS app (updated signals)
