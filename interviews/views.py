...
from interviews.forms import AppointmentForm, AppointmentRequestForm, ClientDataForm, SlotForm
...
from interviews.settings import check_q_cluster
...
from interviews.utils.email_ops import notify_admin_about_appointment, notify_admin_about_reschedule, \
    send_reschedule_confirmation_email, \
    send_thank_you_email
from interviews.utils.session import get_appointment_data_from_session, handle_existing_email
from interviews.utils.view_helpers import get_locale
...
def prepare_reschedule_appointment(request, id_request):
    ...
    if not can_appointment_be_rescheduled(ar):
        url = reverse('interviews:appointment_request', kwargs={'service_id': ar.service.id})
