...
from interviews.utils.date_time import convert_minutes_in_human_readable_format, get_timestamp, get_weekday_num, \
    time_difference
from interviews.utils.view_helpers import generate_random_id, get_locale
...
class Appointment(models.Model):
    ...
    def get_absolute_url(self, request=None):
        url = reverse('interviews:display_appointment', args=[str(self.id)])
