# session.py
# Path: interviews/utils/session.py
...
from interviews.utils.db_helpers import get_user_by_email
from interviews.utils.email_ops import send_verification_email
