# json_context.py
# Path: interviews/utils/json_context.py
...
from interviews.settings import APPOINTMENT_ADMIN_BASE_TEMPLATE, APPOINTMENT_BASE_TEMPLATE
from interviews.utils.db_helpers import username_in_user_model
