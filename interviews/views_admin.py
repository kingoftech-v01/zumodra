# views_admin.py
# Path: interviews/views_admin.py
# Url root: /app-admins/
...
from interviews.decorators import (
    require_ajax, require_staff_or_superuser, require_superuser, require_user_authenticated)
from interviews.forms import PersonalInformationForm, ServiceForm, StaffAppointmentInformationForm, StaffMemberForm
from interviews.messages_ import appt_updated_successfully
from interviews.models import Appointment, DayOff, StaffMember, WorkingHours
...
from interviews.utils.json_context import (
    convert_appointment_to_json, get_generic_context, get_generic_context_with_extra, handle_unauthorized_response,
    json_response)
from interviews.utils.permissions import check_extensive_permissions, check_permissions, \
