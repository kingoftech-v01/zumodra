...
from accounts.services import log_authentication_event
...
def register_auditlog_models():
    ...
    excluded = AUDITLOG_FIELD_EXCLUSIONS.get('accounts.User', [])
    auditlog.register(User, exclude_fields=excluded)

    excluded = AUDITLOG_FIELD_EXCLUSIONS.get('accounts.KYCVerification', [])
...
class AuditLoggingMiddleware(MiddlewareMixin):
    ...
    def _extract_resource_type(path):
        ...
        # /api/v1/ats/jobs/ -> Job
        # /api/v1/ats/candidates/ -> Candidate
