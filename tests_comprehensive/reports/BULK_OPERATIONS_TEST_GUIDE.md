...
**Current State:** REST API endpoint for bulk import available at `/api/v1/ats/candidates/bulk-import/`
...
url = "http://localhost:8002/api/v1/ats/candidates/bulk-import/"
headers = {
...
```javascript
const url = "http://localhost:8002/api/v1/ats/candidates/bulk-import/";
const headers = {
