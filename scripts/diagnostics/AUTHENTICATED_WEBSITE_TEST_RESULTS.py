...
2. ATS Jobs (/en-us/app/ats/jobs/)
   ...
   POTENTIAL ISSUES TO CHECK:
   - URL: Check ats/urls_frontend.py for 'frontend:jobs:job_list'
   - View: Check ats/template_views.py or ats/views.py
   - Template: templates/jobs/jobs/list.html or similar
...
3. ATS Candidates (/en-us/app/ats/candidates/)
   ...
   POTENTIAL ISSUES TO CHECK:
   - URL: 'frontend:jobs:candidate_list' in ats/urls_frontend.py
   - View: CandidateListView in ats/template_views.py
   - Template: templates/jobs/candidates/list.html
...
4. ATS Applications (/en-us/app/ats/applications/)
   ...
   POTENTIAL ISSUES TO CHECK:
   - URL: 'frontend:jobs:application_list'
   - View: ApplicationListView
   - Template: templates/jobs/applications/list.html
...
5. ATS Pipeline (/en-us/app/ats/pipeline/)
   ...
   POTENTIAL ISSUES TO CHECK:
   - URL: 'frontend:jobs:pipeline_board' or similar
   - View: PipelineBoardView
   - Template: templates/jobs/pipeline/board.html
...
6. ATS Interviews (/en-us/app/ats/interviews/)
   ...
   POTENTIAL ISSUES TO CHECK:
   - URL: 'frontend:jobs:interview_list'
   - View: InterviewListView, InterviewScheduleView, InterviewFeedbackView
   - Template: templates/jobs/interviews/list.html, schedule.html, feedback.html
