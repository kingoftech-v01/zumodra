...
class EndpointTester:
    ...
    def test_ats_endpoints(self):
        ...
        ats_endpoints = [
            ('/api/v1/jobs/categories/', 'GET', 'Job Categories List'),
            ('/api/v1/jobs/pipelines/', 'GET', 'Pipelines List'),
            ('/api/v1/jobs/stages/', 'GET', 'Pipeline Stages List'),
            ('/api/v1/jobs/jobs/', 'GET', 'Job Postings List'),
            ('/api/v1/jobs/candidates/', 'GET', 'Candidates List'),
            ('/api/v1/jobs/applications/', 'GET', 'Applications List'),
            ('/api/v1/jobs/interviews/', 'GET', 'Interviews List'),
            ('/api/v1/jobs/feedback/', 'GET', 'Interview Feedback List'),
            ('/api/v1/jobs/offers/', 'GET', 'Offers List'),
            ('/api/v1/jobs/saved-searches/', 'GET', 'Saved Searches List'),
            ('/api/v1/jobs/dashboard/stats/', 'GET', 'Dashboard Stats'),
            ('/api/v1/jobs/interview-slots/', 'GET', 'Interview Slots List'),
            ('/api/v1/jobs/offer-templates/', 'GET', 'Offer Templates List'),
            ('/api/v1/jobs/approvals/', 'GET', 'Offer Approvals List'),
        ]
