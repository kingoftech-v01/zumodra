...
- **Jobs & Recruitment** for recruitment workflows
...
### 3. ATS (Applicant Tracking System) (`jobs/`)
...
```
1. Client Request
   └─> https://acme.zumodra.com/app/jobs/jobs/
...
**Permission Checking:**
```python
from tenant_profiles.permissions import check_tenant_permission
...
│   │
│   ├── /jobs/               # Applicant Tracking System
│   │   ├── /jobs/          # Job postings
│   │   ├── /candidates/    # Candidates
