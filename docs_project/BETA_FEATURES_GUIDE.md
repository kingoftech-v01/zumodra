...
```
/frontend/jobs/applications/{uuid}/background-check/initiate/
/frontend/jobs/applications/{uuid}/background-check/status/
/frontend/jobs/applications/{uuid}/background-check/report/
```
...
View background checks at: `/admin/jobs/backgroundcheck/`
