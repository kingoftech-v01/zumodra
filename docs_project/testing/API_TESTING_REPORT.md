...
- `/api/v1/jobs/jobs/` - Job listings
- `/api/v1/jobs/candidates/` - Candidate management
- `/api/v1/jobs/applications/` - Applications
- `/api/v1/jobs/interviews/` - Interview scheduling
- `/api/v1/jobs/offers/` - Job offers
- `/api/v1/jobs/pipelines/` - Recruitment pipelines
- `/api/v1/jobs/pipeline-stages/` - Pipeline stages
...
### Recruitment & HR
- **ATS** (`/api/v1/jobs/`) - Jobs, candidates, applications, interviews, offers
