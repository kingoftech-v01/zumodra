...
- Navigate to Jobs List (`/app/jobs/jobs/`)
- Create New Job (click create button, verify form)
- Navigate to Candidates (`/app/jobs/candidates/`)
- Navigate to Interviews (`/app/jobs/interviews/`)
- Navigate to Pipeline Board (`/app/jobs/pipeline/`)
