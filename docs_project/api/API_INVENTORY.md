...
**URL Namespace:** `api:v1:jobs:*`
**Files:** [ats/urls.py](../jobs/urls.py), [ats/views.py](../jobs/views.py), [ats/serializers.py](../jobs/serializers.py)

### Core Resources

#### Job Categories
- `GET /api/v1/jobs/job-categories/` - List all categories
- `POST /api/v1/jobs/job-categories/` - Create category
- `GET /api/v1/jobs/job-categories/{id}/` - Retrieve category
- `PUT/PATCH /api/v1/jobs/job-categories/{id}/` - Update category
- `DELETE /api/v1/jobs/job-categories/{id}/` - Delete category

#### Pipelines
- `GET /api/v1/jobs/pipelines/` - List all pipelines
- `POST /api/v1/jobs/pipelines/` - Create pipeline
- `GET /api/v1/jobs/pipelines/{id}/` - Retrieve pipeline
- `PUT/PATCH /api/v1/jobs/pipelines/{id}/` - Update pipeline
- `DELETE /api/v1/jobs/pipelines/{id}/` - Delete pipeline
- `POST /api/v1/jobs/pipelines/{id}/add_stage/` - Add stage to pipeline
- `POST /api/v1/jobs/pipelines/{id}/reorder_stages/` - Reorder stages
- `POST /api/v1/jobs/pipelines/{id}/set_default/` - Set as default pipeline

#### Job Postings
- `GET /api/v1/jobs/jobs/` - List all jobs
- `POST /api/v1/jobs/jobs/` - Create job
- `GET /api/v1/jobs/jobs/{id}/` - Retrieve job
- `PUT/PATCH /api/v1/jobs/jobs/{id}/` - Update job
...
- `POST /api/v1/jobs/jobs/{id}/clone/` - Duplicate job
- `GET /api/v1/jobs/jobs/{id}/applications/` - Get applications for job
- `GET /api/v1/jobs/jobs/{id}/kanban/` - Get Kanban board data
- `GET /api/v1/jobs/jobs/{id}/stats/` - Get job statistics

#### Candidates
- `GET /api/v1/jobs/candidates/` - List all candidates
- `POST /api/v1/jobs/candidates/` - Create candidate
- `GET /api/v1/jobs/candidates/{id}/` - Retrieve candidate
- `PUT/PATCH /api/v1/jobs/candidates/{id}/` - Update candidate
- `DELETE /api/v1/jobs/candidates/{id}/` - Delete candidate
- `POST /api/v1/jobs/candidates/bulk_import/` - Bulk import candidates (CSV)
- `POST /api/v1/jobs/candidates/{id}/merge/` - Merge duplicate candidates
- `POST /api/v1/jobs/candidates/{id}/add_tag/` - Add tag to candidate
- `POST /api/v1/jobs/candidates/{id}/remove_tag/` - Remove tag from candidate

#### Applications
- `GET /api/v1/jobs/applications/` - List all applications
- `POST /api/v1/jobs/applications/` - Create application
- `GET /api/v1/jobs/applications/{id}/` - Retrieve application
- `PUT/PATCH /api/v1/jobs/applications/{id}/` - Update application
- `DELETE /api/v1/jobs/applications/{id}/` - Delete application
- `POST /api/v1/jobs/applications/{id}/move_stage/` - Move to different stage
- `POST /api/v1/jobs/applications/{id}/reject/` - Reject application
- `POST /api/v1/jobs/applications/{id}/advance/` - Advance to next stage
- `POST /api/v1/jobs/applications/{id}/assign/` - Assign to recruiter
- `POST /api/v1/jobs/applications/{id}/rate/` - Add rating
- `GET /api/v1/jobs/applications/{id}/notes/` - Get application notes

#### Interviews
- `GET /api/v1/jobs/interviews/` - List all interviews
- `POST /api/v1/jobs/interviews/` - Schedule interview
- `GET /api/v1/jobs/interviews/{id}/` - Retrieve interview
- `PUT/PATCH /api/v1/jobs/interviews/{id}/` - Update interview
- `DELETE /api/v1/jobs/interviews/{id}/` - Delete interview
- `POST /api/v1/jobs/interviews/{id}/reschedule/` - Reschedule interview
- `POST /api/v1/jobs/interviews/{id}/complete/` - Mark as complete
- `POST /api/v1/jobs/interviews/{id}/cancel/` - Cancel interview
- `POST /api/v1/jobs/interviews/{id}/feedback/` - Submit feedback

#### Offers
- `GET /api/v1/jobs/offers/` - List all offers
- `POST /api/v1/jobs/offers/` - Create offer
- `GET /api/v1/jobs/offers/{id}/` - Retrieve offer
- `PUT/PATCH /api/v1/jobs/offers/{id}/` - Update offer
- `DELETE /api/v1/jobs/offers/{id}/` - Delete offer
- `POST /api/v1/jobs/offers/{id}/send/` - Send offer to candidate
- `POST /api/v1/jobs/offers/{id}/accept/` - Accept offer (candidate)
- `POST /api/v1/jobs/offers/{id}/decline/` - Decline offer (candidate)
- `POST /api/v1/jobs/offers/{id}/approve/` - Approve offer (manager)
- `POST /api/v1/jobs/offers/{id}/withdraw/` - Withdraw offer
...
**Location:** `POST /api/v1/jobs/bulk/`, `/api/v1/jobs/candidates/bulk_import/`
