...
1. Job Listing View (`/app/ats/jobs/`)
2. Candidate List View (`/app/ats/candidates/`)
3. Application Detail View (`/app/ats/applications/[id]/`)
4. Interview List View (`/app/ats/interviews/`)
5. Pipeline Board View (`/app/ats/pipeline/`)
6. Job Creation Form (`/app/ats/jobs/create/`)
7. Interview Scheduling (`/app/ats/interviews/schedule/`)
8. Offer List View (`/app/ats/offers/`)
