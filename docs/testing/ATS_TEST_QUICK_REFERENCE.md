...
| # | Scenario | URL | Status |
|---|----------|-----|--------|
| 1 | Job Listing | `/en-us/app/ats/jobs/` | ⬜ |
| 2 | Candidate List | `/en-us/app/ats/candidates/` | ⬜ |
| 3 | Application Detail | `/en-us/app/ats/applications/[id]/` | ⬜ |
| 4 | Interview List | `/en-us/app/ats/interviews/` | ⬜ |
| 5 | Pipeline Board | `/en-us/app/ats/pipeline/` | ⬜ |
| 6 | Job Creation | `/en-us/app/ats/jobs/create/` | ⬜ |
| 7 | Interview Scheduling | `/en-us/app/ats/interviews/schedule/` | ⬜ |
| 8 | Offer List | `/en-us/app/ats/offers/` | ⬜ |
