...
### ATS Module
- [ ] `/ats/jobs/` - Job list page
- [ ] `/ats/jobs/create/` - Job creation form
- [ ] `/ats/jobs/<uuid>/` - Job detail page
- [ ] `/ats/candidates/` - Candidate list page
- [ ] `/ats/candidates/create/` - Candidate creation form (WILL FAIL - missing candidate_edit URL)
- [ ] `/ats/candidates/<uuid>/` - Candidate detail page (WILL FAIL - missing URLs)
- [ ] `/ats/pipeline/` - Pipeline board
- [ ] `/ats/applications/<uuid>/` - Application detail page (WILL FAIL - missing application_note URL)
- [ ] `/ats/interviews/` - Interview list
- [ ] `/ats/interviews/<uuid>/` - Interview detail page
- [ ] `/ats/offers/` - Offer list
...
- `templates/ats/job_list.html`
- `templates/ats/job_detail.html`
- `templates/ats/job_form.html`
- `templates/ats/candidate_list.html`
- `templates/ats/candidate_detail.html`
- `templates/ats/candidate_form.html`
- `templates/ats/candidate_card.html`
- `templates/ats/pipeline_board.html`
- `templates/ats/application_detail.html`
- `templates/ats/interview_list.html`
- `templates/ats/interview_detail.html`
- `templates/ats/interview_schedule.html`
- `templates/ats/interview_feedback.html`
- `templates/ats/offer_list.html`
- `templates/ats/offer_detail.html`
- `templates/ats/offer_form.html`
- `templates/ats/review_hire.html`
- `templates/ats/partials/*.html`
