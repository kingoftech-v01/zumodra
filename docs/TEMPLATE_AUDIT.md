...
### ATS Module (templates/ats/) - 23 Files
**URL Namespace:** `frontend:ats:*`

**Main Templates:**
- [job_list.html](../templates/ats/job_list.html) - Tab-based job filtering with HTMX
- [job_detail.html](../templates/ats/job_detail.html)
- [job_form.html](../templates/ats/job_form.html) - Create/edit form
- [candidate_list.html](../templates/ats/candidate_list.html)
- [candidate_detail.html](../templates/ats/candidate_detail.html)
- [candidate_form.html](../templates/ats/candidate_form.html)
- [candidate_card.html](../templates/ats/candidate_card.html) - Reusable card
- [pipeline_board.html](../templates/ats/pipeline_board.html) - Kanban board (HTMX drag-and-drop)
- [application_detail.html](../templates/ats/application_detail.html)
- [interview_list.html](../templates/ats/interview_list.html)
- [interview_detail.html](../templates/ats/interview_detail.html)
- [interview_schedule.html](../templates/ats/interview_schedule.html)
- [interview_feedback.html](../templates/ats/interview_feedback.html)
- [offer_list.html](../templates/ats/offer_list.html)
- [offer_detail.html](../templates/ats/offer_detail.html)
- [offer_form.html](../templates/ats/offer_form.html)
- [review_hire.html](../templates/ats/review_hire.html)

**HTMX Partials (templates/ats/partials/):**
...
<!-- Modal loading -->
hx-get="{% url 'frontend:ats:candidate_add_to_job' candidate.id %}"
hx-target="#modal-container"
hx-swap="innerHTML"

<!-- Form submission -->
hx-post="{% url 'frontend:ats:email_compose' %}"
...
```html
<button hx-get="{% url 'frontend:ats:job_list' %}?status=published"
        hx-target="#jobs-table-container"
        hx-swap="innerHTML"
        hx-push-url="true">
    Published Jobs
...
```html
<form hx-post="{% url 'frontend:ats:email_compose' %}"
      hx-target="#email-compose-modal"
      hx-swap="outerHTML">
    {% csrf_token %}
    <!-- form fields -->
...
```html
<form hx-post="{% url 'frontend:ats:job_create' %}"
      hx-target="this"
      hx-swap="outerHTML">
    {% csrf_token %}
    <!-- form fields -->
...
<a href="{% url 'frontend:ats:job_list' %}">Jobs</a>
<a href="{% url 'frontend:ats:job_detail' job.pk %}">{{ job.title }}</a>
...
|----------|---------------|---------------|
| frontend:ats:job_list | templates/ats/job_list.html | dashboard_base.html |
```
