...
| POST | `/api/v1/ats/jobs/` | Create a job |
| GET | `/api/v1/ats/jobs/{id}/` | Get job details |
| PUT | `/api/v1/ats/jobs/{id}/` | Update job |
...
| POST | `/api/v1/ats/applications/` | Submit application |
| GET | `/api/v1/ats/applications/{id}/` | Get application |
| POST | `/api/v1/ats/applications/{id}/move-stage/` | Move to stage |
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/api/v1/ats/interviews/` | List interviews |
| POST | `/api/v1/ats/interviews/` | Schedule interview |
| POST | `/api/v1/ats/interviews/{id}/complete/` | Mark complete |
| POST | `/api/v1/ats/interviews/{id}/feedback/` | Add feedback |

#### Offers

| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/api/v1/ats/offers/` | List offers |
| POST | `/api/v1/ats/offers/` | Create offer |
| POST | `/api/v1/ats/offers/{id}/send/` | Send offer |
| POST | `/api/v1/ats/offers/{id}/accept/` | Accept offer |
| POST | `/api/v1/ats/offers/{id}/decline/` | Decline offer |
...
class ZumodraClient:
    ...
    def list_jobs(self):
        response = requests.get(
            f"{self.base_url}/api/v1/ats/jobs/",
    ...
    def create_application(self, job_id, candidate_data):
        response = requests.post(
            f"{self.base_url}/api/v1/ats/applications/",
            headers=self.headers,
...
class ZumodraClient {
    ...
    async createApplication(jobId, candidateData) {
        const response = await fetch(
            `${this.baseUrl}/api/v1/ats/applications/`,
            {
                method: 'POST',
                headers: this.headers,
