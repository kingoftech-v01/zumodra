    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.CharField(choices=[('fixed', 'Fixed Price'), ('hourly', 'Hourly Rate'), ('custom', 'Custom Quote')], default='fixed', max_length=20)),
                ('price', models.DecimalField(blank=True, decimal_places=2, help_text='Price for fixed-price services', max_digits=10, null=True)),
                ...
                ('delivery_type', models.CharField(choices=[('remote', 'Remote'), ('onsite', 'On-Site'), ('hybrid', 'Hybrid')], default='remote', max_length=20)),
                ('duration_days', models.PositiveSmallIntegerField(blank=True, help_text='Estimated delivery time in days', null=True)),
                ...
                ('is_active', models.BooleanField(default=True, help_text='Service is active and available for booking within tenant')),
                ('is_featured', models.BooleanField(default=False, help_text='Featured services appear prominently in tenant marketplace')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_type', models.CharField(choices=[('fixed', 'Fixed'), ('hourly', 'Hourly')], default='fixed', max_length=20)),
                ('currency', models.CharField(default='CAD', max_length=3)),
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('pending_payment', 'Pending Payment'), ('funded', 'Funded (Escrow)'), ('in_progress', 'In Progress'), ('delivered', 'Delivered'), ('revision_requested', 'Revision Requested'), ('completed', 'Completed'), ('disputed', 'Disputed'), ('cancelled', 'Cancelled'), ('refunded', 'Refunded')], default='draft', max_length=20)),
                ...
                ('escrow_transaction', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='service_contract', to='finance.escrowtransaction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responded_at', models.DateTimeField(blank=True, help_text='When provider responded', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_lat', models.FloatField(blank=True, null=True)),
                ('location_lng', models.FloatField(blank=True, null=True)),
                ('hourly_rate', models.DecimalField(blank=True, decimal_places=2, help_text='Default hourly rate', max_digits=10, null=True)),
                ...
                ('availability_status', models.CharField(choices=[('available', 'Available'), ('busy', 'Busy'), ('unavailable', 'Unavailable'), ('on_vacation', 'On Vacation')], default='available', max_length=20)),
