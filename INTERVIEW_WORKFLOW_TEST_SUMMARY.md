...
1. `GET /api/v1/ats/interviews/` - List interviews
2. `GET /api/v1/ats/interviews/{uuid}/` - Get single interview
3. `POST /api/v1/ats/interviews/` - Create interview
4. `PATCH /api/v1/ats/interviews/{uuid}/` - Update interview
5. `DELETE /api/v1/ats/interviews/{uuid}/` - Delete interview
6. `POST /api/v1/ats/interviews/{uuid}/reschedule/` - Reschedule
7. `POST /api/v1/ats/interviews/{uuid}/complete/` - Mark completed
8. `POST /api/v1/ats/interviews/{uuid}/cancel/` - Cancel interview
9. `GET /api/v1/ats/interviews/{uuid}/feedback/` - Get feedback
10. `POST /api/v1/ats/interviews/{uuid}/feedback/` - Submit feedback
11. `GET /api/v1/ats/interviews/my_interviews/` - Get interviewer's interviews
12. `GET /api/v1/ats/interviews/upcoming/` - Get upcoming interviews (7 days)
...
**Actions:**
- `list` - GET /api/v1/ats/interviews/
- `retrieve` - GET /api/v1/ats/interviews/{uuid}/
- `create` - POST /api/v1/ats/interviews/
- `update`/`partial_update` - PATCH /api/v1/ats/interviews/{uuid}/
- `destroy` - DELETE /api/v1/ats/interviews/{uuid}/ (admin only)
- `reschedule` - POST /api/v1/ats/interviews/{uuid}/reschedule/
- `complete` - POST /api/v1/ats/interviews/{uuid}/complete/
- `cancel` - POST /api/v1/ats/interviews/{uuid}/cancel/
- `feedback` - GET/POST /api/v1/ats/interviews/{uuid}/feedback/
- `my_interviews` - GET /api/v1/ats/interviews/my_interviews/
- `upcoming` - GET /api/v1/ats/interviews/upcoming/
...
- `/c/Users/techn/OneDrive/Documents/zumodra/ats/models.py` - Interview models (2496-2930)
- `/c/Users/techn/OneDrive/Documents/zumodra/ats/forms.py` - Interview forms (315-420)
- `/c/Users/techn/OneDrive/Documents/zumodra/ats/views.py` - Interview ViewSets (1548-1706)
- `/c/Users/techn/OneDrive/Documents/zumodra/ats/serializers.py` - Interview serializers (1220-1350)
