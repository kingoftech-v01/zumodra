...
**Affected Endpoints:**
- `/api/v1/ats/jobs/` - GET
- `/api/v1/ats/candidates/` - GET
- `/api/v1/ats/applications/` - GET
- `/api/v1/ats/interviews/` - GET
- `/api/v1/ats/offers/` - GET
- `/api/v1/ats/pipelines/` - GET
...
>>> from accounts.models import Organization  # Adjust import as needed
...
# Test ATS endpoint
curl -H "Authorization: Bearer $TOKEN" http://localhost:8002/api/v1/ats/jobs/
