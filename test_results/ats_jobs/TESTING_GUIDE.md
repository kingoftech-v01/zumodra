...
|-------------|------------|---------|--------------|
| `/app/ats/jobs/` | `JobListView` | List all jobs | GET |
| `/app/ats/jobs/create/` | `JobCreateView` | Create new job | GET, POST |
| `/app/ats/jobs/<uuid>/` | `JobDetailView` | View job details | GET |
| `/app/ats/jobs/<uuid>/edit/` | `JobEditView` | Edit existing job | GET, POST |
| `/app/ats/jobs/<uuid>/publish/` | `JobPublishView` | Publish draft job | POST |
| `/app/ats/jobs/<uuid>/close/` | `JobCloseView` | Close open job | POST |
| `/app/ats/jobs/<uuid>/duplicate/` | `JobDuplicateView` | Duplicate job | POST |
| `/app/ats/jobs/<uuid>/delete/` | `JobDeleteView` | Soft delete job | DELETE |
...
**URL:** https://demo-company.zumodra.rhematek-solutions.com/app/ats/jobs/
...
**URL:** https://demo-company.zumodra.rhematek-solutions.com/app/ats/jobs/create/
...
**URL:** https://demo-company.zumodra.rhematek-solutions.com/app/ats/jobs/`<uuid>`/
...
**URL:** https://demo-company.zumodra.rhematek-solutions.com/app/ats/jobs/`<uuid>`/edit/
...
# URL name: 'frontend:ats:job_detail'
```
...
**URL:** https://demo-company.zumodra.rhematek-solutions.com/app/ats/jobs/`<uuid>`/publish/
...
**URL:** https://demo-company.zumodra.rhematek-solutions.com/app/ats/jobs/`<uuid>`/close/
...
**URL:** https://demo-company.zumodra.rhematek-solutions.com/app/ats/jobs/`<uuid>`/duplicate/
...
**URL:** https://demo-company.zumodra.rhematek-solutions.com/app/ats/jobs/`<uuid>`/delete/
...
1. **Invalid UUID:** Try accessing `/app/ats/jobs/invalid-uuid/`
   - Expected: 404 page
...
1. **JobDetailView (line 305):**
   - Success URL uses `'ats:job-detail'` but should be `'frontend:ats:job_detail'`
   - This may cause 404 on redirect after job creation
   - **VERIFY:** Check if redirect works correctly

2. **JobEditView (line 1667):**
   - Uses `'frontend:ats:job_detail'` (correct namespace)
