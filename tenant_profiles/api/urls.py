...
# ============================================================================
# API URLPATTERNS (JSON responses)
# ============================================================================
...
# ============================================================================
# FRONTEND URLPATTERNS (HTML template responses)
# ============================================================================

from .. import template_views_freelancer

frontend_urlpatterns = [
    # Freelancer Profile Browsing (Public)
    path(
        'freelancers/',
        template_views_freelancer.freelancer_browse,
        name='freelancer_browse'
    ),
    path(
        'freelancers/available/',
        template_views_freelancer.freelancer_available,
        name='freelancer_available'
    ),

    # Freelancer Profile Detail (Public)
    path(
        'freelancers/<uuid:uuid>/',
        template_views_freelancer.freelancer_detail,
        name='freelancer_detail'
    ),

    # Freelancer Profile Management (Authenticated - Own Profile)
    path(
        'my-freelancer-profile/',
        template_views_freelancer.freelancer_profile_me,
        name='freelancer_profile_me'
    ),
    path(
        'my-freelancer-profile/create/',
        template_views_freelancer.freelancer_profile_create,
        name='freelancer_profile_create'
    ),
    path(
        'my-freelancer-profile/<uuid:uuid>/edit/',
        template_views_freelancer.freelancer_profile_edit,
        name='freelancer_profile_edit'
    ),
    path(
        'my-freelancer-profile/dashboard/',
        template_views_freelancer.freelancer_profile_dashboard,
        name='freelancer_profile_dashboard'
    ),

    # Freelancer Custom Actions
    path(
        'my-freelancer-profile/<uuid:uuid>/toggle-availability/',
        template_views_freelancer.freelancer_toggle_availability,
        name='freelancer_toggle_availability'
    ),
]
...
app_name = 'tenant_profiles'

urlpatterns = [
    # API URLs: /api/v1/accounts/
