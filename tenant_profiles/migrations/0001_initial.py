    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_primary', models.BooleanField(db_index=True, default=False, help_text='Primary/default CV')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('searching', 'Searching'), ('matched', 'Matched with Employer'), ('confirmed', 'Confirmed'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], db_index=True, default='searching', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('unverified', 'Unverified'), ('pending', 'Verification Pending'), ('in_progress', 'In Progress'), ('verified', 'Verified'), ('disputed', 'Disputed'), ('unable', 'Unable to Verify'), ('expired', 'Verification Expired')], db_index=True, default='unverified', max_length=20)),
                ('verification_token', models.CharField(blank=True, db_index=True, max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified_at', models.DateTimeField(blank=True, null=True)),
                ('expires_at', models.DateTimeField(blank=True, db_index=True, help_text='Verification expiry (typically 2 years)', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('professional_title', models.CharField(help_text='e.g., "Full Stack Developer", "Graphic Designer"', max_length=200)),
                ('bio', models.TextField(blank=True, help_text='Professional bio and experience summary')),
                ('availability_status', models.CharField(choices=[('available', 'Available for Work'), ('busy', 'Currently Busy'), ('unavailable', 'Not Available')], db_index=True, default='available', max_length=20)),
                ('availability_hours_per_week', models.PositiveIntegerField(default=40, help_text='Available hours per week (1-168)', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(168)])),
                ('hourly_rate', models.DecimalField(decimal_places=2, help_text='Hourly rate in currency below', max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('hourly_rate_currency', models.CharField(choices=[('CAD', 'CAD'), ('USD', 'USD'), ('EUR', 'EUR'), ('GBP', 'GBP')], default='CAD', max_length=3)),
                ('minimum_project_budget', models.DecimalField(blank=True, decimal_places=2, help_text='Minimum budget for accepting fixed-price projects', max_digits=10, null=True)),
                ('skills', models.JSONField(blank=True, default=list, help_text='List of skills (e.g., ["Python", "Django", "React"])')),
                ('years_of_experience', models.PositiveSmallIntegerField(default=0, help_text='Total years of professional experience')),
                ...
                ('remote_only', models.BooleanField(default=True, help_text='Only accepts remote work')),
                ('is_verified', models.BooleanField(db_index=True, default=False, help_text='Profile verified by platform admin')),
                ...
                ('completed_services', models.PositiveIntegerField(default=0, help_text='Total completed service contracts')),
                ('total_earnings', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Total lifetime earnings on platform', max_digits=12)),
                ('total_earnings_currency', models.CharField(default='CAD', max_length=3)),
                ('average_rating', models.DecimalField(blank=True, decimal_places=2, help_text='Average rating from 0.00 to 5.00', max_digits=3, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00')), django.core.validators.MaxValueValidator(Decimal('5.00'))])),
                ('total_reviews', models.PositiveIntegerField(default=0, help_text='Total number of reviews received')),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('last_active_at', models.DateTimeField(blank=True, help_text='Last time freelancer was active on platform', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('verification_type', models.CharField(choices=[('identity', 'Identity Verification'), ('address', 'Address Verification'), ('employment', 'Employment Verification'), ('education', 'Education Verification'), ('background', 'Background Check'), ('business', 'Business Verification')], db_index=True, max_length=20)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('in_progress', 'In Progress'), ('verified', 'Verified'), ('rejected', 'Rejected'), ('expired', 'Expired'), ('requires_update', 'Requires Update')], db_index=True, default='pending', max_length=20)),
                ('level', models.CharField(choices=[('basic', 'Basic (Email + Phone)'), ('standard', 'Standard (ID Verification)'), ('enhanced', 'Enhanced (Background Check)'), ('complete', 'Complete (Full Verification)')], db_index=True, default='basic', max_length=20)),
                ...
                ('document_file', models.FileField(blank=True, help_text='Uploaded KYC document (ID, passport, etc.)', null=True, upload_to='kyc_documents/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf', 'jpg', 'jpeg', 'png'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('result', models.CharField(choices=[('success', 'Success'), ('failed', 'Failed'), ('blocked', 'Blocked'), ('mfa_required', 'MFA Required')], db_index=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not_requested', 'Not Requested'), ('pending', 'Pending'), ('granted', 'Granted'), ('denied', 'Denied'), ('revoked', 'Revoked'), ('expired', 'Expired')], db_index=True, default='not_requested', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('published', 'Published'), ('under_review', 'Under Review'), ('disputed', 'Disputed'), ('validated', 'Validated'), ('rejected', 'Rejected'), ('hidden', 'Hidden')], db_index=True, default='pending', max_length=20)),
                ('is_negative', models.BooleanField(db_index=True, default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment_status', models.CharField(choices=[('active', 'Currently Enrolled'), ('on_coop', 'On Co-op Term'), ('graduated', 'Graduated'), ('withdrawn', 'Withdrawn'), ('suspended', 'Suspended')], db_index=True, default='active', max_length=20)),
                ('enrollment_verified', models.BooleanField(db_index=True, default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_type', models.CharField(choices=[('full_time', 'Full Time'), ('part_time', 'Part Time'), ('contract', 'Contract'), ('temporary', 'Temporary'), ('intern', 'Intern/Co-op'), ('freelance', 'Freelance')], default='full_time', max_length=20)),
                ...
                ('email', models.EmailField(blank=True, help_text='Synced from PublicProfile.public_email', max_length=254)),
                ('phone', models.CharField(blank=True, help_text='Synced from PublicProfile.phone', max_length=30)),
                ('city', models.CharField(blank=True, max_length=100)),
                ...
                ('github_url', models.URLField(blank=True)),
                ('portfolio_url', models.URLField(blank=True)),
                ('skills_json', models.JSONField(blank=True, default=list, help_text='Synced from PublicProfile.skills')),
                ('languages_json', models.JSONField(blank=True, default=list, help_text='Synced from PublicProfile.languages')),
                ('last_synced_at', models.DateTimeField(blank=True, help_text='When profile was last synced from PublicProfile', null=True)),
                ('synced_fields', models.JSONField(blank=True, default=list, help_text='List of field names that were synced')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('role', models.CharField(choices=[('owner', 'Owner/PDG'), ('admin', 'Administrator'), ('hr_manager', 'HR Manager'), ('recruiter', 'Recruiter'), ('hiring_manager', 'Hiring Manager'), ('employee', 'Employee'), ('viewer', 'Viewer (Read-only)')], db_index=True, default='employee', max_length=20)),
                ('job_title', models.CharField(blank=True, max_length=100)),
                ('is_active', models.BooleanField(db_index=True, default=True)),
                ('is_primary_tenant', models.BooleanField(db_index=True, default=False, help_text="Is this the user's primary tenant?")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_id_verified', models.BooleanField(db_index=True, default=False, help_text='Level 1: KYC verified')),
                ('is_career_verified', models.BooleanField(db_index=True, default=False, help_text='Level 2: 80%+ career verified')),
