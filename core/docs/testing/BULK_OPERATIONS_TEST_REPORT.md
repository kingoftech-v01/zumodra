...
1. **Jobs & Recruitment** - Candidates and Job Postings
...
- REST endpoint: `/api/v1/jobs/candidates/bulk-import/`
...
**Recommendation:** Add endpoint like `/api/v1/jobs/candidates/template/download/`
...
1. **Add Web UI Endpoints for Template Download**
   - GET `/api/v1/jobs/candidates/template/` returns CSV template
   - GET `/api/v1/jobs/jobs/template/` returns CSV template
