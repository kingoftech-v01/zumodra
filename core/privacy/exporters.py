...
class GDPRDataExporter:
    ...
    EXPORT_MODELS = [
        ...
        ('accounts.UserProfile', 'user', 'Profile Information'),
        ('accounts.TenantUser', 'user', 'Tenant Memberships'),
        ('accounts.KYCVerification', 'user', 'KYC Verifications'),
        ('accounts.ProgressiveConsent', 'grantor', 'Data Consents Given'),
        ('accounts.DataAccessLog', 'data_subject', 'Data Access History'),
        ('accounts.LoginHistory', 'user', 'Login History'),
        ('accounts.SecurityQuestion', 'user', 'Security Questions'),
        ('ats.Candidate', 'email', 'Job Applications'),
        ('ats.Interview', 'candidate__email', 'Interview Records'),
