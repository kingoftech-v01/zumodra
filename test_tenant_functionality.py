#!/usr/bin/env python
"""
Comprehensive Tenant Testing Script for Zumodra

This script tests:
1. Freelancer Tenant (demo-freelancer.zumodra.rhematek-solutions.com)
   - Homepage and public pages
   - Login page
   - Comparison with company tenant
   - Unique freelancer functionality

2. Tenant 404 Page (nonexistent-tenant.zumodra.rhematek-solutions.com)
   - 404 error display
   - Beautiful error page rendering
   - Error messaging and suggestions

Usage:
    python test_tenant_functionality.py
"""
