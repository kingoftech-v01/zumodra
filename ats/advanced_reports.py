...
class RecruitingFunnelReportService(ReportService):
    ...
    def generate(
        ...
        """
        from ats.models import Application, ApplicationActivity, Pipeline, PipelineStage
...
class RecruiterPerformanceReportService(ReportService):
    ...
    def generate(
        ...
        """
        from ats.models import Application, JobPosting, Interview
...
class HiringManagerScorecardService(ReportService):
    ...
    def generate(
        ...
        """
        from ats.models import Application, JobPosting, Interview, Offer
