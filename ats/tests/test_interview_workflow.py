...
from ats.forms import InterviewScheduleForm, InterviewFeedbackForm
from ats.views import InterviewViewSet
from ats.services import InterviewSchedulingService
...
class TestInterviewScheduling:
    ...
    @patch('ats.services.InterviewSchedulingService.send_scheduling_email')
...
class TestInterviewRescheduling:
    ...
    @patch('ats.services.InterviewSchedulingService.send_reschedule_notification')
...
class TestInterviewCancellation:
    ...
    @patch('ats.services.InterviewSchedulingService.send_cancellation_email')
