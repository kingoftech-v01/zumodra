...
class ATSPermissions:
    ...
    CAN_CREATE_APPLICATION = 'ats.add_application'
    CAN_CHANGE_APPLICATION = 'ats.change_application'
    CAN_DELETE_APPLICATION = 'ats.delete_application'
    CAN_VIEW_APPLICATION = 'ats.view_application'
    ...
    CAN_CREATE_JOB = 'ats.add_jobposting'
    CAN_CHANGE_JOB = 'ats.change_jobposting'
    CAN_DELETE_JOB = 'ats.delete_jobposting'
    CAN_PUBLISH_JOB = 'ats.publish_jobposting'
    CAN_CLOSE_JOB = 'ats.close_jobposting'

    CAN_HIRE_CANDIDATE = 'ats.hire_application'
    CAN_REJECT_APPLICATION = 'ats.reject_application'
    CAN_ADVANCE_APPLICATION = 'ats.advance_application'
    ...
    def verify_candidate_access(user, candidate: 'Candidate') -> bool:
        ...
        """
        return ATSPermissions.check_object_permission(
            user, candidate, 'ats.view_candidate'
        )
