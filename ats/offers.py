...
from ats.models import OfferTemplate, OfferApproval
...
# Note: OfferTemplate model is imported from ats.models
...
# Note: OfferApproval model is imported from ats.models
