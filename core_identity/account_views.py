...
# KYC Verification
# =============================================================================
# REMOVED: iDenfy stub code (2026-01-17)
# Reason: Zumodra uses Onfido for KYC verification (core/integrations/kyc.py)
# All KYC verification is handled via Onfido's production-ready integration

@login_required
def launch_kyc_view(request):
    """
    Launch KYC verification page.

    Redirects to Onfido-powered KYC flow.
    See core/integrations/kyc.py for implementation.
    """
    return redirect('kyc_verification')  # Onfido integration
