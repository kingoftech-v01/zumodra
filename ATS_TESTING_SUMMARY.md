...
Test all authenticated ATS frontend functionality to ensure recruiters and hiring managers can effectively:
- Manage job postings
...
- Tests all 10+ ATS frontend views
...
|---|---------------|-----|----------|----------|
| 1 | Job Listing View | `/en-us/app/ats/jobs/` | ⭐⭐⭐⭐⭐ | Grid/table of jobs with search, filters, create button |
| 2 | Candidate List View | `/en-us/app/ats/candidates/` | ⭐⭐⭐⭐⭐ | List of candidates with search and filters |
| 3 | Pipeline Board View | `/en-us/app/ats/pipeline/` | ⭐⭐⭐⭐⭐ | Kanban board with drag-and-drop |
| 4 | Application Detail View | `/en-us/app/ats/applications/[id]/` | ⭐⭐⭐⭐⭐ | Full application info with actions |
| 5 | Interview List View | `/en-us/app/ats/interviews/` | ⭐⭐⭐⭐ | List of interviews with filters |
| 6 | Job Creation Form | `/en-us/app/ats/jobs/create/` | ⭐⭐⭐⭐ | Complete job posting form |
| 7 | Interview Scheduling | `/en-us/app/ats/interviews/schedule/` | ⭐⭐⭐⭐ | Schedule interview with date/time/interviewers |
| 8 | Offer List View | `/en-us/app/ats/offers/` | ⭐⭐⭐ | List of employment offers |

### Additional Tests

| # | Test Scenario | URL | Priority |
|---|---------------|-----|----------|
| 9 | Job Detail View | `/en-us/app/ats/jobs/[id]/` | ⭐⭐⭐⭐ |
| 10 | Candidate Detail View | `/en-us/app/ats/candidates/[id]/` | ⭐⭐⭐⭐ |
| 11 | Job Editing | `/en-us/app/ats/jobs/[id]/edit/` | ⭐⭐⭐ |
| 12 | Job Duplication | Action from job detail | ⭐⭐⭐ |
| 13 | Job Deletion | Action from job detail | ⭐⭐⭐ |
| 14 | Interview Rescheduling | `/en-us/app/ats/interviews/[id]/reschedule/` | ⭐⭐⭐ |
| 15 | Interview Cancellation | Action from interview detail | ⭐⭐⭐ |
| 16 | Interview Feedback | `/en-us/app/ats/interviews/[id]/feedback/` | ⭐⭐⭐ |
| 17 | Offer Creation | `/en-us/app/ats/offers/create/[app_id]/` | ⭐⭐⭐ |
...
**Test:**
1. Navigate to `/en-us/app/ats/pipeline/`
...
- **Templates:** `templates/ats/*.html`

### Django URL Namespaces
All ATS frontend URLs use: `frontend:ats:*`
