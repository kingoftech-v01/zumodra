...
from jobs.models import InterviewSlot
...
class InterviewSchedulingService:
    ...
    def schedule_interview(
        ...
        if user is not None:
            if not hasattr(user, 'has_perm') or not (
                user.has_perm('jobs.schedule_interview') or
                user.has_perm('jobs.manage_interviews') or
    ...
    def reschedule_interview(
        ...
        # Log activity
        from jobs.models import ApplicationActivity
