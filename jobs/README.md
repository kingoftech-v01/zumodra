...
The Jobs app is Zumodra's core recruitment module, providing a complete hiring pipeline from job posting to offer acceptance. It enables recruiters to manage jobs, candidates, applications, interviews, and offers within a customizable pipeline system.
...
**Partials (`templates/jobs/partials/`):**
...
For questions or issues related to the Jobs app:
