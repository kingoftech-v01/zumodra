...
### Working Features
- Job list page (`/app/jobs/jobs/`): Proper auth redirect
- Candidate list page (`/app/jobs/candidates/`): Proper auth redirect
...
1. **500 Errors on Some URLs**:
   - `/jobs/applications/` returns 500 instead of redirect
   - `/jobs/pipeline/` returns 500 instead of redirect
...
All ATS URLs should be under `/app/jobs/` prefix:
- Jobs: `/app/jobs/jobs/`
- Candidates: `/app/jobs/candidates/`
- Pipeline: `/app/jobs/pipeline/`
- Interviews: `/app/jobs/interviews/`
- Offers: `/app/jobs/offers/`
