    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'New'), ('in_review', 'In Review'), ('shortlisted', 'Shortlisted'), ('interviewing', 'Interviewing'), ('offer_pending', 'Offer Pending'), ('offer_extended', 'Offer Extended'), ('background_check_pending', 'Background Check Pending'), ('background_check_in_progress', 'Background Check In Progress'), ('background_check_cleared', 'Background Check Cleared'), ('background_check_failed', 'Background Check Failed'), ('hired', 'Hired'), ('rejected', 'Rejected'), ('withdrawn', 'Withdrawn'), ('on_hold', 'On Hold')], db_index=True, default='new', max_length=35)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='jobs.application')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='jobs.application')),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ats_applicationnote_set', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique identifier for external API access', unique=True, verbose_name='UUID')),
                ('provider', models.CharField(choices=[('checkr', 'Checkr'), ('sterling', 'Sterling'), ('hireright', 'HireRight')], help_text='Background check service provider', max_length=50, verbose_name='Provider')),
                ('external_candidate_id', models.CharField(blank=True, help_text="Provider's candidate identifier", max_length=255, verbose_name='External Candidate ID')),
                ('external_report_id', models.CharField(blank=True, help_text="Provider's report identifier", max_length=255, verbose_name='External Report ID')),
                ('package', models.CharField(choices=[('basic', 'Basic - Identity + Criminal'), ('standard', 'Standard - Basic + Employment'), ('pro', 'Pro - Standard + Education'), ('comprehensive', 'Comprehensive - Pro + MVR + Credit')], default='standard', help_text='Screening package selected', max_length=100, verbose_name='Package')),
                ('status', models.CharField(choices=[('pending', 'Pending Initiation'), ('invited', 'Invitation Sent'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('failed', 'Failed'), ('cancelled', 'Cancelled')], default='pending', help_text='Current status of the background check', max_length=50, verbose_name='Status')),
                ('result', models.CharField(blank=True, choices=[('clear', 'Clear'), ('consider', 'Consider'), ('suspended', 'Suspended')], help_text='Final result of the background check', max_length=50, null=True, verbose_name='Result')),
                ('initiated_at', models.DateTimeField(auto_now_add=True, verbose_name='Initiated At')),
                ('completed_at', models.DateTimeField(blank=True, null=True, verbose_name='Completed At')),
                ('report_url', models.URLField(blank=True, help_text="URL to view the full report on provider's site", verbose_name='Report URL')),
                ('report_data', models.JSONField(blank=True, default=dict, help_text='Full report data from provider', verbose_name='Report Data')),
                ('consent_given', models.BooleanField(default=False, help_text='Candidate has given consent for background check', verbose_name='Consent Given')),
                ('consent_ip_address', models.GenericIPAddressField(blank=True, help_text='IP address from which consent was given', null=True, verbose_name='Consent IP Address')),
                ('consent_timestamp', models.DateTimeField(blank=True, help_text='When consent was given', null=True, verbose_name='Consent Timestamp')),
                ('notes', models.TextField(blank=True, help_text='Internal notes about this background check', verbose_name='Notes')),
                ('application', models.ForeignKey(help_text='The application this background check is for', on_delete=django.db.models.deletion.CASCADE, related_name='background_checks', to='jobs.application', verbose_name='Application')),
                ('initiated_by', models.ForeignKey(blank=True, help_text='User who initiated the background check', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='initiated_background_checks', to=settings.AUTH_USER_MODEL, verbose_name='Initiated By')),
                ('tenant', models.ForeignKey(help_text='The tenant this record belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='tenants.tenant', verbose_name='Tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(db_index=True, default=True, help_text='Designates whether this record is active.', verbose_name='Is active')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique identifier for external API access', unique=True, verbose_name='UUID')),
                ('document_type', models.CharField(choices=[('ssn_trace', 'SSN Trace'), ('criminal_county', 'County Criminal Records'), ('criminal_state', 'State Criminal Records'), ('criminal_federal', 'Federal Criminal Records'), ('employment', 'Employment Verification'), ('education', 'Education Verification'), ('mvr', 'Motor Vehicle Records'), ('credit', 'Credit Report'), ('license', 'Professional License'), ('reference', 'Reference Check'), ('drug_test', 'Drug Screening'), ('other', 'Other')], help_text='Type of screening or document', max_length=100, verbose_name='Document Type')),
                ('external_document_id', models.CharField(blank=True, help_text="Provider's document identifier", max_length=255, verbose_name='External Document ID')),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('failed', 'Failed'), ('unable_to_verify', 'Unable to Verify')], default='pending', max_length=50, verbose_name='Status')),
                ('result', models.CharField(blank=True, choices=[('clear', 'Clear'), ('consider', 'Consider'), ('suspended', 'Suspended'), ('records_found', 'Records Found'), ('verified', 'Verified'), ('not_verified', 'Not Verified')], max_length=50, verbose_name='Result')),
                ('completed_at', models.DateTimeField(blank=True, null=True, verbose_name='Completed At')),
                ('document_data', models.JSONField(blank=True, default=dict, help_text='Full document data from provider', verbose_name='Document Data')),
                ('findings_summary', models.TextField(blank=True, help_text='Summary of findings for this document', verbose_name='Findings Summary')),
                ('background_check', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='jobs.backgroundcheck', verbose_name='Background Check')),
                ('tenant', models.ForeignKey(help_text='The tenant this record belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='tenants.tenant', verbose_name='Tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('career_page', 'Career Page'), ('linkedin', 'LinkedIn'), ('indeed', 'Indeed'), ('referral', 'Employee Referral'), ('agency', 'Recruitment Agency'), ('direct', 'Direct Application'), ('imported', 'Imported'), ('other', 'Other')], default='direct', max_length=35)),
                ...
                ('version', models.PositiveIntegerField(default=1, help_text='Record version for optimistic locking.', verbose_name='Version')),
                ('deleted_by', models.ForeignKey(blank=True, help_text='User who deleted this record.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ...
                ('tenant', models.ForeignKey(help_text='The tenant this record belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='tenants.tenant', verbose_name='Tenant')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='candidate_profile_ats', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('interview_type', models.CharField(choices=[('phone', 'Phone Screen'), ('video', 'Video Interview'), ('in_person', 'In-Person'), ('technical', 'Technical Interview'), ('panel', 'Panel Interview'), ('assessment', 'Assessment/Test'), ('final', 'Final Interview'), ('culture_fit', 'Culture Fit'), ('case_study', 'Case Study'), ('behavioral', 'Behavioral Interview')], default='video', max_length=35)),
                ('status', models.CharField(choices=[('scheduled', 'Scheduled'), ('confirmed', 'Confirmed'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('cancelled', 'Cancelled'), ('no_show', 'No Show'), ('rescheduled', 'Rescheduled')], db_index=True, default='scheduled', max_length=35)),
                ...
                ('meeting_provider', models.CharField(blank=True, choices=[('zoom', 'Zoom'), ('teams', 'Microsoft Teams'), ('meet', 'Google Meet'), ('webex', 'Cisco Webex'), ('custom', 'Custom/Other')], help_text='Video conferencing platform', max_length=35)),
                ...
                ('organizer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='organized_interviews', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommendation', models.CharField(choices=[('strong_yes', 'Strong Yes'), ('yes', 'Yes'), ('maybe', 'Maybe'), ('no', 'No'), ('strong_no', 'Strong No')], max_length=35)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('booked_by_interview', models.OneToOneField(blank=True, help_text='The interview that booked this slot', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='booked_slot', to='jobs.interview')),
                ('interviewer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interview_slots', to=settings.AUTH_USER_MODEL)),
                ('tenant', models.ForeignKey(help_text='The tenant this record belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='tenants.tenant', verbose_name='Tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_interview_templates', to=settings.AUTH_USER_MODEL)),
                ('tenant', models.ForeignKey(help_text='The tenant this record belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='tenants.tenant', verbose_name='Tenant')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Template used for this interview', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='interviews', to='jobs.interviewtemplate'),
        ),
        migrations.CreateModel(
            name='JobCategory',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('pending_approval', 'Pending Approval'), ('open', 'Open'), ('on_hold', 'On Hold'), ('closed', 'Closed'), ('filled', 'Filled'), ('cancelled', 'Cancelled')], db_index=True, default='draft', max_length=35)),
                ...
                ('job_type', models.CharField(choices=[('full_time', 'Full-time'), ('part_time', 'Part-time'), ('contract', 'Contract'), ('internship', 'Internship'), ('temporary', 'Temporary'), ('freelance', 'Freelance')], default='full_time', max_length=35)),
                ('experience_level', models.CharField(choices=[('entry', 'Entry Level'), ('junior', 'Junior (1-2 years)'), ('mid', 'Mid-Level (3-5 years)'), ('senior', 'Senior (5-8 years)'), ('lead', 'Lead (8+ years)'), ('executive', 'Executive')], default='mid', max_length=35)),
                ('remote_policy', models.CharField(choices=[('on_site', 'On-site'), ('remote', 'Fully Remote'), ('hybrid', 'Hybrid'), ('flexible', 'Flexible')], default='on_site', max_length=35)),
                ...
                ('salary_period', models.CharField(choices=[('hourly', 'Hourly'), ('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly'), ('yearly', 'Yearly')], default='yearly', max_length=35)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('status', models.CharField(choices=[('draft', 'Draft'), ('pending_approval', 'Pending Approval'), ('approved', 'Approved'), ('sent', 'Sent to Candidate'), ('accepted', 'Accepted'), ('declined', 'Declined'), ('expired', 'Expired'), ('withdrawn', 'Withdrawn'), ('countered', 'Counter-Offered')], default='draft', max_length=35)),
                ('approval_status', models.CharField(choices=[('not_required', 'Not Required'), ('pending_approval', 'Pending Approval'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='not_required', help_text='Current approval workflow status', max_length=35)),
                ...
                ('esign_provider', models.CharField(blank=True, choices=[('docusign', 'DocuSign'), ('hellosign', 'HelloSign/Dropbox Sign'), ('adobe_sign', 'Adobe Sign'), ('pandadoc', 'PandaDoc'), ('manual', 'Manual/Offline')], help_text='E-signature provider (docusign, hellosign, etc.)', max_length=35)),
                ...
                ('previous_offer', models.ForeignKey(blank=True, help_text='Previous offer in the counter-offer chain', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='counter_offers', to='jobs.offer')),
            ],
            options={
                'verbose_name': 'Offer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected'), ('skipped', 'Skipped'), ('expired', 'Expired')], default='pending', max_length=35)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('approver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='offer_approvals', to=settings.AUTH_USER_MODEL)),
                ('offer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='jobs.offer')),
                ('requested_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='requested_offer_approvals', to=settings.AUTH_USER_MODEL)),
                ('tenant', models.ForeignKey(help_text='The tenant this record belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='tenants.tenant', verbose_name='Tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(blank=True, max_length=100)),
                ('job_type', models.CharField(blank=True, choices=[('full_time', 'Full-time'), ('part_time', 'Part-time'), ('contract', 'Contract'), ('internship', 'Internship'), ('temporary', 'Temporary'), ('freelance', 'Freelance')], max_length=35)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_offer_templates', to=settings.AUTH_USER_MODEL)),
                ('tenant', models.ForeignKey(help_text='The tenant this record belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='tenants.tenant', verbose_name='Tenant')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='offer',
            name='offer_template',
            field=models.ForeignKey(blank=True, help_text='Template used to create this offer', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='offers', to='jobs.offertemplate'),
        ),
        migrations.CreateModel(
            name='Pipeline',
            fields=[
        ...
        migrations.AddField(
            ...
            name='pipeline',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jobs', to='jobs.pipeline'),
        ),
        migrations.CreateModel(
            name='PipelineStage',
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('name', models.CharField(max_length=100)),
                ('stage_type', models.CharField(choices=[('new', 'New/Applied'), ('screening', 'Screening'), ('assessment', 'Assessment'), ('interview', 'Interview'), ('reference', 'Reference Check'), ('offer', 'Offer'), ('hired', 'Hired'), ('rejected', 'Rejected'), ('withdrawn', 'Withdrawn'), ('on_hold', 'On Hold')], default='new', max_length=35)),
                ('description', models.TextField(blank=True)),
                ...
                ('pipeline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stages', to='jobs.pipeline')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='application',
            name='current_stage',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='applications', to='jobs.pipelinestage'),
        ),
        migrations.CreateModel(
            name='SavedSearch',
            fields=[
                ...
                ('alert_frequency', models.CharField(choices=[('instant', 'Instant'), ('daily', 'Daily'), ('weekly', 'Weekly')], default='daily', max_length=35)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['status'], name='jobs_backgr_status_1d3ae7_idx'),
        ),
        migrations.AddIndex(
            model_name='backgroundcheck',
            index=models.Index(fields=['result'], name='jobs_backgr_result_9166c8_idx'),
        ),
        migrations.AddIndex(
            model_name='backgroundcheck',
            index=models.Index(fields=['provider'], name='jobs_backgr_provide_bc36e2_idx'),
        ),
        migrations.AddIndex(
            model_name='backgroundcheck',
            index=models.Index(fields=['external_report_id'], name='jobs_backgr_externa_5a0dcf_idx'),
        ),
        migrations.AddConstraint(
            model_name='backgroundcheck',
            constraint=models.UniqueConstraint(fields=('tenant', 'application'), name='unique_background_check_per_application'),
        ),
        migrations.AddIndex(
            model_name='backgroundcheckdocument',
            index=models.Index(fields=['document_type'], name='jobs_backgr_documen_cd0d52_idx'),
        ),
        migrations.AddIndex(
            model_name='backgroundcheckdocument',
            index=models.Index(fields=['status'], name='jobs_backgr_status_d00c1b_idx'),
        ),
        migrations.AddIndex(
            model_name='backgroundcheckdocument',
            index=models.Index(fields=['result'], name='jobs_backgr_result_11a0f5_idx'),
        ),
        migrations.AddIndex(
            model_name='candidate',
            index=models.Index(fields=['email'], name='jobs_candid_email_dc85d4_idx'),
        ),
        migrations.AddIndex(
            model_name='candidate',
            index=models.Index(fields=['source', 'created_at'], name='jobs_candid_source_0680a4_idx'),
        ),
        migrations.AddConstraint(
            model_name='candidate',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['interviewer', 'start_time'], name='jobs_interv_intervi_55c5b2_idx'),
        ),
        migrations.AddIndex(
            model_name='interviewslot',
            index=models.Index(fields=['is_available', 'start_time'], name='jobs_interv_is_avai_9ce9af_idx'),
        ),
        migrations.AddIndex(
            model_name='interviewslot',
            index=models.Index(fields=['start_time', 'end_time'], name='jobs_interv_start_t_98f2ff_idx'),
        ),
        migrations.AddConstraint(
            model_name='interviewslot',
        ...
        migrations.AddIndex(
            model_name='interview',
            index=models.Index(fields=['application', 'status'], name='jobs_interv_applica_1c625c_idx'),
        ),
        migrations.AddIndex(
            model_name='interview',
            index=models.Index(fields=['scheduled_start', 'status'], name='jobs_interv_schedul_b8f0af_idx'),
        ),
        migrations.AddIndex(
            model_name='interview',
            index=models.Index(fields=['interview_type', 'scheduled_start'], name='jobs_interv_intervi_f301f0_idx'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['offer', 'status'], name='jobs_offera_offer_i_4b2a9e_idx'),
        ),
        migrations.AddIndex(
            model_name='offerapproval',
            index=models.Index(fields=['approver', 'status'], name='jobs_offera_approve_ec5a25_idx'),
        ),
        migrations.AddIndex(
            model_name='offerapproval',
            index=models.Index(fields=['level', 'status'], name='jobs_offera_level_802b3e_idx'),
        ),
        migrations.AddConstraint(
            model_name='offerapproval',
        ...
        migrations.AddIndex(
            model_name='offer',
            index=models.Index(fields=['application', 'status'], name='jobs_offer_applica_e9808a_idx'),
        ),
        migrations.AddIndex(
            model_name='offer',
            index=models.Index(fields=['approval_status'], name='jobs_offer_approva_62f280_idx'),
        ),
        migrations.AddIndex(
            model_name='offer',
            index=models.Index(fields=['status', 'created_at'], name='jobs_offer_status_504b2b_idx'),
        ),
        migrations.AddConstraint(
            model_name='pipeline',
        ...
        migrations.AddIndex(
            model_name='jobposting',
            index=models.Index(fields=['status', 'created_at'], name='jobs_jobpos_status_7192dc_idx'),
        ),
        migrations.AddIndex(
            model_name='jobposting',
            index=models.Index(fields=['category', 'status'], name='jobs_jobpos_categor_241cd4_idx'),
        ),
        migrations.AddIndex(
            model_name='jobposting',
        ...
        migrations.AddIndex(
            model_name='application',
            index=models.Index(fields=['job', 'current_stage'], name='jobs_applic_job_id_4418f4_idx'),
        ),
        migrations.AddIndex(
            model_name='application',
            index=models.Index(fields=['candidate', 'applied_at'], name='jobs_applic_candida_255eab_idx'),
        ),
        migrations.AddConstraint(
            model_name='application',
