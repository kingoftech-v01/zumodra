...
def test_jobs_list(token: str):
    """Test GET /api/v1/jobs/jobs/ - List Jobs"""
    print("\n" + "="*80)
...
def test_create_job(token: str) -> Optional[str]:
    """Test POST /api/v1/jobs/jobs/ - Create Job"""
    print("\n" + "="*80)
...
def test_job_detail(token: str, job_id: str):
    """Test GET /api/v1/jobs/jobs/<id>/ - Job Detail"""
    print("\n" + "="*80)
...
def test_update_job(token: str, job_id: str):
    """Test PATCH /api/v1/jobs/jobs/<id>/ - Update Job"""
    print("\n" + "="*80)
...
def test_candidates_list(token: str):
    """Test GET /api/v1/jobs/candidates/ - List Candidates"""
    print("\n" + "="*80)
...
def test_applications_list(token: str):
    """Test GET /api/v1/jobs/applications/ - List Applications"""
    print("\n" + "="*80)
...
def test_interviews_list(token: str):
    """Test GET /api/v1/jobs/interviews/ - List Interviews"""
    print("\n" + "="*80)
...
def test_pipelines_list(token: str):
    """Test GET /api/v1/jobs/pipelines/ - List Pipelines"""
    print("\n" + "="*80)
...
def test_delete_job(token: str, job_id: str):
    """Test DELETE /api/v1/jobs/jobs/<id>/ - Delete Job"""
    print("\n" + "="*80)
