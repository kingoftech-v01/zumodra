...
- PATCH /api/v1/jobs/jobs/{id}/ - Update job
...
- POST /api/v1/jobs/jobs/{id}/duplicate/ - Duplicate job
- POST /api/v1/jobs/jobs/{id}/applications/ - Create application
- GET /api/v1/jobs/jobs/{id}/applications/ - List applications
"""
...
class TestJobPostingAPIPermissions:
    ...
    def test_recruiter_can_create_job(self):
        ...
        try:
            ...
            has_perm = self.user.has_perm('jobs.add_jobposting')
    ...
    def test_recruiter_can_edit_job(self):
        ...
        try:
            has_perm = self.user.has_perm('jobs.change_jobposting')
    ...
    def test_recruiter_can_delete_job(self):
        ...
        try:
            has_perm = self.user.has_perm('jobs.delete_jobposting')
...
def print_summary():
    ...
    print("="*80)
    print("\nTest Coverage:")
    print("  ✅ Create (POST /api/v1/jobs/jobs/)")
    print("  ✅ Read (GET /api/v1/jobs/jobs/, GET /api/v1/jobs/jobs/{id}/)")
    print("  ✅ Update (PATCH /api/v1/jobs/jobs/{id}/)")
    print("  ✅ Delete (DELETE /api/v1/jobs/jobs/{id}/)")
    print("  ✅ Publish (POST /api/v1/jobs/jobs/{id}/publish/)")
    print("  ✅ Close (POST /api/v1/jobs/jobs/{id}/close/)")
    print("  ✅ Duplicate (POST /api/v1/jobs/jobs/{id}/duplicate/)")
    print("  ✅ Applications (POST/GET /api/v1/jobs/jobs/{id}/applications/)")
