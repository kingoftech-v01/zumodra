...
**Files Involved:**
- `/c/Users/techn/OneDrive/Documents/zumodra/jobs/models.py` - JobPosting model
- `/c/Users/techn/OneDrive/Documents/zumodra/jobs/forms.py` - JobPostingForm
- `/c/Users/techn/OneDrive/Documents/zumodra/jobs/validators.py` - Custom validators
...
**Endpoints Tested:**
- POST /api/v1/jobs/jobs/ (Create): ✅ 201
- GET /api/v1/jobs/jobs/ (List): ✅ 200
- GET /api/v1/jobs/jobs/{id}/ (Retrieve): ✅ 200
- PATCH /api/v1/jobs/jobs/{id}/ (Update): ✅ 200
- DELETE /api/v1/jobs/jobs/{id}/ (Delete): ✅ 204
- POST /api/v1/jobs/jobs/{id}/publish/: ✅ 200
- POST /api/v1/jobs/jobs/{id}/close/: ✅ 200
- POST /api/v1/jobs/jobs/{id}/duplicate/: ✅ 201
- POST /api/v1/jobs/jobs/{id}/applications/: ✅ 201
- GET /api/v1/jobs/jobs/{id}/applications/: ✅ 200
